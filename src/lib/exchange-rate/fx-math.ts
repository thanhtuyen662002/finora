...
/**
 * Validates and normalizes a rate string to 12 decimal places without floating-point math.
 */
export function toExactRate(rate: string | number): string {
  ...
  fractionalPart = fractionalPart.padEnd(12, '0').slice(0, 12);
