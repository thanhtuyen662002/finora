export type ReceiptSupportedCurrency = 'VND' | 'USD' | 'EUR' | 'JPY' | 'CNY' | 'KRW';

export type ReceiptDocumentKind = 'PURCHASE_RECEIPT' | 'INVOICE' | 'CREDIT_NOTE' | 'OTHER';
...
export interface ReceiptVisionParseOutput {
  ...
  readonly currency_code: ReceiptSupportedCurrency | null;
